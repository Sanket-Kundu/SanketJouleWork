...
const Large: React.FC<{ className?: string }> = ({ className }) => (
  <svg width="320" height="240" viewBox="0 0 320 240" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
<rect y="68.6001" width="320" height="138" rx="24" fill="var(--sapContent_Illustrative_Color20)"/>
<g clipPath="url(#clip0_6848_476324)">
