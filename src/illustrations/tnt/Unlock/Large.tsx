...
const Large: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="320" height="240" fill="none" viewBox="0 0 320 240" className={className}>
  <path fill="var(--sapContent_Illustrative_Color20)" fillRule="evenodd" d="M320 83v90c0 13.246-10.754 24-24 24H24c-13.246 0-24-10.754-24-24V83c0-13.246 10.754-24 24-24h272c13.246 0 24 10.754 24 24Z" clipRule="evenodd"/>
