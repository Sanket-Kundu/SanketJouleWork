...
const ExtraSmall: React.FC<{ className?: string }> = ({ className }) => (
  ...
  <g clipPath="url(#a)">
    <path fill="var(--sapContent_Illustrative_Color21)" fillRule="evenodd" d="m12.063 40.397 26.502-4.733c.164-.03.17-.261.01-.303l-16.618-4.14a1.534 1.534 0 0 0-.608-.027L.425 34.418a.378.378 0 0 0-.101.717l11.138 5.18a.998.998 0 0 0 .603.078l-.002.004Z" clipRule="evenodd"/>
