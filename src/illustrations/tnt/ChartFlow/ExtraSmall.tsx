...
const ExtraSmall: React.FC<{ className?: string }> = ({ className }) => (
  ...
  <path fill="var(--sapContent_Illustrative_Color21)" fillRule="evenodd" d="m13.783 38.688 30.54-5.454c.191-.034.198-.302.012-.348l-19.15-4.77a1.762 1.762 0 0 0-.702-.032L.37 31.8a.436.436 0 0 0-.117.827l12.836 5.97c.215.1.458.132.694.088v.003Z" clipRule="evenodd"/>
