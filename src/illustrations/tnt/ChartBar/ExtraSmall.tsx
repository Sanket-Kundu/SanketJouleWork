...
const ExtraSmall: React.FC<{ className?: string }> = ({ className }) => (
  ...
  <g clipPath="url(#a)">
    <path fill="var(--sapContent_Illustrative_Color21)" fillRule="evenodd" d="m13.783 38.694 30.54-5.454c.19-.034.197-.302.012-.348l-19.15-4.77a1.764 1.764 0 0 0-.702-.033L.37 31.806a.436.436 0 0 0-.117.827l12.836 5.969c.215.1.458.133.694.09v.002Z" clipRule="evenodd"/>
