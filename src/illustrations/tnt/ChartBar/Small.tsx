...
const Small: React.FC<{ className?: string }> = ({ className }) => (
  ...
  <path fill="var(--sapContent_Illustrative_Color21)" fillRule="evenodd" d="m44.654 93.684 59.062-10.546c.368-.066.381-.584.022-.673L66.704 73.24a3.41 3.41 0 0 0-1.356-.063l-46.633 7.188c-.824.128-.984 1.245-.226 1.6l24.823 11.542a2.22 2.22 0 0 0 1.343.173v.004Z" clipRule="evenodd"/>
